  ...
  return (
    <section id="home" className="min-h-[60vh] sm:min-h-[80vh] md:min-h-screen flex items-center justify-center text-gray-800 relative overflow-hidden pt-12 sm:pt-16 dark:text-white">
      <motion.div 
        ...
        className="container mx-auto px-4 flex flex-col items-center justify-center text-center py-4 sm:py-8 md:py-12"
      >
        {/* Main large horizontal text */}
        <motion.h1 
          variants={itemVariants}
          className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-extrabold text-gray-900 tracking-tight leading-none mb-2 sm:mb-4 whitespace-normal sm:whitespace-nowrap dark:text-white px-2"
        >
        ...
        <motion.span 
          ...
          initial="hidden"
          animate="visible"
          className="text-lg sm:text-xl md:text-2xl text-gray-700 font-semibold tracking-wide mb-4 sm:mb-6 md:mb-8 lg:mb-12 dark:text-gray-300"
        >
        ...
        <motion.p 
          variants={itemVariants}
          className="text-gray-700 text-sm sm:text-base md:text-lg max-w-2xl mx-auto mb-2 sm:mb-4 md:mb-6 lg:mb-8 dark:text-gray-300 px-4"
        >
